...
The deliverable is one read, rendered at three depths: a tight cue for a solo advocate's single post, a fuller read for a journalist or monitor, a dossier for an institution. Same engine and guarantees, different packaging.
Three concrete users anchored to the 18 April 2027 Finnish parliamentary election: a public-service newsroom such as Yle; a fact-checking and civil-society monitor such as Faktabaari within the EDMO Nordic hub; and the Finnish Ministry of Justice as the election authority. Possible first collaboration partner: Faktabaari, direct contact in hand, not confirmed, owner Liisi.
TO SET: the single user and job to serve first, and the MVP anchor, a meeting decision, with the Ministry of Justice election scenario the strong candidate.
...
Non-goals, hard: no enforcement output of any kind; the tool never publishes to a platform; no identification or re-identification of any person; no social-media scraping; synthetic data is for testing only and never a source; no scores or accuracy claims while the classifier is untrained.
...
- Outputs are three, all more speech or no action: protect the debate, add context, counter a narrative. No enforcement path, and the tool never publishes to any platform; it drafts, humans publish. [BUILD, must]
...
- Data is a licensed corpus plus synthetic for testing only, never synthetic as a source, never scraping; a small slice of compliant live data is an MVP element if feasible. [BUILD, must]
...
- Closed deliberation output set, the three reframed poles, no enforcement path; the tool produces drafts and evidence and never publishes. [BUILD, must]
...
- The deliverable rendered at three depths: a cue for a solo advocate, a fuller read for a monitor, a dossier for an institution. [BUILD, should]
...
Counter-speech scaffold
- A workbench for one hardening subnarrative: the narrative made explicit, a group-level audience read, candidate verified context with sources, and editable draft framings from the local model. The human edits and publishes through their own channel; the tool never posts. [BUILD, should]
...
- The showstopper: an election-period timeline, the strong candidate being the Ministry of Justice scenario across the 18 April 2027 vote. The anchor is a meeting decision; exact content TO SET; data source under research.
...
- The MVP and showstopper anchor, a meeting decision; the Ministry of Justice election scenario is the strong candidate. OPEN.
- Possible first collaboration partner: Faktabaari, not confirmed, owner Liisi. OPEN.
