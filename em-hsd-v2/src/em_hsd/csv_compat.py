"""PrivHSD CSV I/O with lowercase Reddit column aliases (Johnny contract unchanged)."""
...
from wrapper.csvio import CsvContractError, read_csv as read_privhsd_csv
...
def read_csv_compat(path: str) -> Tuple[List[str], List[Dict[str, str]], Dict[str, str]]:
    ...
    with open(path, "r", encoding="utf-8", newline="") as fh:
        ...
        for i, raw in enumerate(reader):
            ...
            rows.append(row)
        return list(fieldnames), rows, column_map
